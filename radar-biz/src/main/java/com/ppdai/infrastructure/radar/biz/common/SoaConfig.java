...
public class SoaConfig {
	...
	public int getInstanceClearTime() {
		try {
			if (!_instanceClearTime.equals(env.getProperty(env_getInstanceClearTime_key,env_getInstanceClearTime_defaultValue))) {
				_instanceClearTime = env.getProperty(env_getInstanceClearTime_key, env_getInstanceClearTime_defaultValue);
	...
	public int getSoaLockHeartBeatTime() {
		try {
			if (!_soaLockHeartBeatTime.equals(env.getProperty(env_getSoaLockHeartBeatTime_key,env_getSoaLockHeartBeatTime_defaultValue))) {
				_soaLockHeartBeatTime = env.getProperty(env_getSoaLockHeartBeatTime_key, env_getSoaLockHeartBeatTime_defaultValue);
	...
	public int getReinitInterval() {
		try {
			if (!_reinitInterval.equals(env.getProperty(env_getReinitInterval_key,env_getReinitInterval_defaultValue))) {
	...
	public int getCheckPollingDataInterval() {
		try {
			if (!_checkPollingDataInterval.equals(env.getProperty(env_getCheckPollingDataInterval_key,env_getCheckPollingDataInterval_defaultValue))) {
				_checkPollingDataInterval = env.getProperty(env_getCheckPollingDataInterval_key, env_getCheckPollingDataInterval_defaultValue);
	...
	public int getNotifyBatchSize() {
		try {
			if (!_notifyBatchSize.equals(env.getProperty(env_getNotifyBatchSize_key,env_getNotifyBatchSize_defaultValue))) {
	...
	public int getNotifyWaitTime() {
		try {
			if (!_notifyWaitTime.equals(env.getProperty(env_getNotifyWaitTime_key,env_getNotifyWaitTime_defaultValue))) {
	...
	public int getInstanceCleanInterval() {
		try {
			if (!_instanceCleanInterval.equals(env.getProperty(env_getInstanceCleanInterval_key,env_getInstanceCleanInterval_defaultValue))) {
	...
	public int getTaskCleanInterval() {
		try {
			if (!_taskCleanInterval.equals(env.getProperty(env_getTaskCleanInterval_key,env_getTaskCleanInterval_defaultValue))) {
				_taskCleanInterval = env.getProperty(env_getTaskCleanInterval_key, env_getTaskCleanInterval_defaultValue);
	...
	public int getRegisterInstanceThreadSize() {
		try {
			if (!_registerInstanceThreadSize.equals(env.getProperty(env_getRegisterInstanceThreadSize_key,env_getRegisterInstanceThreadSize_defaultValue))) {
				_registerInstanceThreadSize = env.getProperty(env_getRegisterInstanceThreadSize_key, env_getRegisterInstanceThreadSize_defaultValue);
	...
	public int getRegisterInstanceSleepTime() {
		try {
			if (!_registerInstanceSleepTime.equals(env.getProperty(env_getRegisterInstanceSleepTime_key,env_getRegisterInstanceSleepTime_defaultValue))) {
				_registerInstanceSleepTime = env.getProperty(env_getRegisterInstanceSleepTime_key, env_getRegisterInstanceSleepTime_defaultValue);
	...
	public int getRegisterClientSleepTime() {
		try {
			if (!_registerClientSleepTime.equals(env.getProperty(env_getRegisterClientSleepTime_key,env_getRegisterClientSleepTime_defaultValue))) {
				_registerClientSleepTime = env.getProperty(env_getRegisterClientSleepTime_key, env_getRegisterClientSleepTime_defaultValue);
	...
	private final String env_getHeartbeatSleepTime_defaultValue="4000";
	private final String env_getHeartbeatSleepTime_des="批量执行心跳间隔时间";

	// 批量执行心跳间隔时间
	public int getHeartbeatSleepTime() {
		try {
			if (!_heartbeatSleepTime.equals(env.getProperty(env_getHeartbeatSleepTime_key,env_getHeartbeatSleepTime_defaultValue))) {
				_heartbeatSleepTime = env.getProperty(env_getHeartbeatSleepTime_key, env_getHeartbeatSleepTime_defaultValue);
				heartbeatSleepTime = Integer.parseInt(_heartbeatSleepTime);
				if (heartbeatSleepTime < 4000) {
					heartbeatSleepTime = 4000;
				}
				onChange();
			}
		} catch (Exception e) {
			heartbeatSleepTime = 1000;
			onChange();
	...
	public int getRegisterClientThreadSize() {
		try {
			if (!_registerClientThreadSize.equals(env.getProperty(env_getRegisterClientThreadSize_key,env_getRegisterClientThreadSize_defaultValue))) {
				_registerClientThreadSize = env.getProperty(env_getRegisterClientThreadSize_key, env_getRegisterClientThreadSize_defaultValue);
	...
	public int getTomcatAcceptCount() {
		try {
			if (!_tomcatAcceptCount.equals(env.getProperty(env_getTomcatAcceptCount_key,env_getTomcatAcceptCount_defaultValue))) {
				_tomcatAcceptCount = env.getProperty(env_getTomcatAcceptCount_key, env_getTomcatAcceptCount_defaultValue);
				tomcatAcceptCount = Integer.parseInt(env.getProperty(env_getTomcatAcceptCount_key, env_getTomcatAcceptCount_defaultValue));
	...
	public boolean getEnableSynAtlas() {
		try {
			if (!_enableSynAtlas.equals(env.getProperty(env_getEnableSynAtlas_key,env_getEnableSynAtlas_defaultValue))) {
	...
	public int getMaxTestCount() {
		try {
			if (!_maxTestCount.equals(env.getProperty(env_getMaxTestCount_key,env_getMaxTestCount_defaultValue))) {
				...
				maxTestCount = Integer.valueOf(env.getProperty(env_getMaxTestCount_key, env_getMaxTestCount_defaultValue));
			}
		} catch (Exception e) {
			maxTestCount = 1000;
		}
